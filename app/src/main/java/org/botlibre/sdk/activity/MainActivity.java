...
public class MainActivity extends LibreActivity {
	 ...
	 */
	public static String applicationId = "7567323488151592486";
	 ...
	 */
	public static String launchInstanceId = "22312997"; // i.e. "171"
	public static String launchInstanceName = "MyDost"; // i.e. "Help Bot"
